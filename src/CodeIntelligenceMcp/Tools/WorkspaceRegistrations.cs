...
public sealed record PythonIndexRegistry(IReadOnlyDictionary<string, PythonIndex> Indexes);
public sealed record JsIndexRegistry(IReadOnlyDictionary<string, JsIndex> Indexes);
