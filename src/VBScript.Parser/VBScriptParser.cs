    ...
    public class VBScriptParser
    {
        ...
        private void SkipComments()
        {
            while (_next is CommentToken tk)
            {
                ...
                if (comment != null)
                {
                    comment.Range = new Ast.Range(marker.Index, _lastMarker.Index);
        ...
        private Marker CreateMarker()
            => new(_startMarker.Index, _startMarker.Line, _startMarker.Column);
        ...
        {
            node.Range = new Ast.Range(marker.Index, _lastMarker.Index);
